...
public class SdkProxy {
	...
	protected void onEnterGame(Map<String, Object> data) {
		...
		mRoleReportListener = kNListener.getRoleReportListener();
		if(mRoleReportListener == null){
			LogUtil.e("没有设置上报游戏数据回调");
		}
		...
		HttpService.enterGame(new BaseListener() {
			...
			public void onSuccess(Object result) {
				LogUtil.i("send enterGame data is successd!");
				mRoleReportListener.onSuccess(result);
			}
			
			@Override
			public void onFail(Object result) {
				LogUtil.i("send enterGame data is failed!");
				mRoleReportListener.onFail(result);
			}
		});
