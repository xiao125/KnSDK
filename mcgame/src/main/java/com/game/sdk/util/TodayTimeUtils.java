...
public class TodayTimeUtils {
    ...
    //获得最后一次账号名
    public static Object   LastName(Activity activity ){
        Object lastName = SpUtil.get(activity,"Loginname","mc");
    ...
    //保存勾选后的账号
    public static void saveExitName(Activity activity,String lastName) {

        SpUtil.put(activity,"Loginname",lastName);
        KnLog.log("保存账号");
    }
